										...
										<div class="box box-primary" style="border: 2px solid #ddd;" >
											...
											<div class="box-body">
												<div class="form-group <?=form_error('product_title') ? 'has-error' : ''?>">
													...
													<input  required type="text" class="form-control the_title" name="product_title" id="product_title" value="<?php echo set_value('product_title'); ?>">
												</div>

												<div class="form-group <?=form_error('product_name') ? 'has-error' : ''?>">
													<label for="product_name">URL Path<span class="required">*</span></label>
													<input required  type="text" class="form-control the_name" name="product_name" id="product_name" value="<?php echo set_value('product_name'); ?>">
												...
												<div class="form-group <?=form_error('sku') ? 'has-error' : ''?>">
													...
													<input required type="text" class="form-control" name="sku" id="sku" value="<?php echo set_value('sku'); ?>">
												</div>

												<div class="form-group <?=form_error('purchase_price') ? 'has-error' : ''?>">
													<label for="purchase_price">Purchase Price</label>
													<input type="text" class="form-control" name="purchase_price" id="purchase_price" value="<?php echo set_value('purchase_price'); ?>">
												</div>

												<div class="form-group <?=form_error('sell_price') ? 'has-error' : ''?>">
													<label for="sell_price">Sell Price<span class="required">*</span></label>
													<input  required type="text" class="form-control" name="sell_price" id="sell_price" value="<?php echo set_value('sell_price'); ?>">
												</div>
												...
												<div class="form-group <?=form_error('product_video') ? 'has-error' : ''?>">
													...
													<input type="text" class="form-control" name="product_video" id="product_video" value="<?php echo set_value('product_video'); ?>">
												</div>
												...
												<div class="form-group <?=form_error('product_summary') ? 'has-error' : ''?>" >
													...
													<textarea class="form-control" rows="10" name="product_summary" id="product_summary"><?php echo set_value('product_summary'); ?>  </textarea>
												</div>
											</div>
										</div>
									</div>
															...
															<ul>
																...
																if(isset($result))
																{
																	foreach($result as $row)
																	{
																		?>
																		<li>
																			<label><input type="checkbox" name="product_size[]" value="<?php echo $row->name;?>" ><?php echo $row->name;?></label>
															...
															<ul>
																...
																if(isset($result))
																{
																	foreach($result as $row)
																	{
																		?>
																		<li>
																			<label><input type="checkbox" name="product_color[]" value="<?php echo $row->product_color_name;?>" ><?php echo $row->product_color_name;?></label>
								...
								<div class="box box-primary" style="border: 2px solid #ddd;" >
									...
									<div class="box-body">
										<div class="form-group <?=form_error('product_description') ? 'has-error' : ''?>">
											<textarea class="form-control" rows="15" name="product_description" id="product_description"><?php echo set_value('product_description'); ?></textarea>
										</div>
									</div>
								</div>
								...
								<div class="box box-primary" style="border: 2px solid #ddd;" >
									...
									<div class="box-body">
										<div class="form-group <?=form_error('product_terms') ? 'has-error' : ''?>">
											<textarea class="form-control" rows="5" name="product_terms" id="product_terms"><?php echo set_value('product_terms'); ?></textarea>
										</div>
									</div>
								</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-sm-6">
															...
															<input type="text" class="form-control" name="discount_price" id="discount_price" value="<?php echo set_value('discount_price'); ?>">
														</div>
														<div class="col-sm-6">
								...
								<div class="box box-primary" style="border: 2px solid #ddd;" >
									...
									<div class="box-body">
										...
										<div class="form-group <?=form_error('seo_keywords') ? 'has-error' : ''?>">
											...
											<textarea class="form-control" rows="5" name="seo_keywords" id="seo_keywords"><?php echo set_value('seo_keywords'); ?></textarea>
										</div>
